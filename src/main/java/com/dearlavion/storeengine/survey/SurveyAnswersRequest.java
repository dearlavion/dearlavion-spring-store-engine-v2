 ...
 * 3 stable codes, because Duration's cardinality is NOT admin-editable (see AdminTaxonomyController)
...
public record SurveyAnswersRequest(
        ...
        @NotBlank @Pattern(regexp = "short|medium|long") String duration,
